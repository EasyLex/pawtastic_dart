...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      resizeToAvoidBottomInset: false,    //Tetep gak bisa hide keyboard
        backgroundColor: const Color.fromARGB(255, 255, 250, 250),
        body: SafeArea(     
          child: SingleChildScrollView(
            // Padding agar isi halaman bagian bawah tidak tertutup bottom bar
            padding: EdgeInsets.only(bottom: 90, top: 25),
            // padding: EdgeInsets.only(bottom: _isKeyboardVisible ? 0 : 90, top: 25), // Adjust padding based on keyboard visibility
            child: Container(
              child: Column(
                children: [
                  Row(
        ...
        //     // Use setState() to trigger a rebuild when keyboard visibility changes
        ...
        //     return _isKeyboardVisible ? SizedBox.shrink() : Bottombar(initialIndex: 0); // Hide bottom bar when keyboard is visible
        //   },
        // ),
      );
